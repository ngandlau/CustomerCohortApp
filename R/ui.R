  ...
  tabsetPanel(
    ...
    tabPanel(
      ...
      radioButtons(inputId = "revenueType", 
                   label = "Metric",
                   choiceNames = c("Revenue per Cohort", "ARPU := Revenue(t) / Customers(t)", "ARPU := Revenue(t) / Customers at Acquisition"),
  ...
  tabPanel(
    ...
    shiny::sidebarLayout(
      ...
      sidebarPanel = shiny::sidebarPanel(
        ...
        numericInput("cac", "Acquisition Cost per Customer", min = 0, value = 250, width = "200px"),
        numericInput("rev", "Revenue per Customer", value = 200, width = "200px"),
        numericInput("cm", "Contribution Margin", min = 0, max = 1, value = 0.8, width = "200px"),
        ...
        conditionalPanel(
          ...
          numericInput("nNewMax", label = "Max. Number of New Customers", value = -1),
          numericInput("cacIncrease", label = "Increase in CAC per Period", value = 0),
          numericInput("cacMax", label = "Max. CAC", value = -1),
          numericInput("revIncrease", label = "Increase in Revenue per Customer per Age", value = 0),
          numericInput("revMax", label = "Max. Revenue per Customer", value = -1),
          numericInput("retRateIncrease", label = "Increase in Customer Retention Rate per Age", value = 0),
